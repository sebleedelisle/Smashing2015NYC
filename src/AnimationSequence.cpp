...
//    }
    ...
    if (bar >= 61.0 && bar < 62.5) {
        ...
        ofSetColor(225, 255,255,progress);
        writeinPNL("GET READY TO CLAP YOUR HANDS");
    }
    
    if (bar >= 62.5 && bar < 62.75) {
        //fade out the text colour
        float progress = ofMap(barfloat, 63.5, 63.75, 255,0);
        ofSetColor(225, 255,255,progress);
        writeinPNL("GET READY TO CLAP YOUR HANDS");
    }
    
    if (bar >= 63.0 && bar < 64.5) {
        //fade in text
    ...
    if (bar >= 65.0 && bar < 66.5) {
        //fade in text
        float progress = ofMap(barfloat, 65, 65.25,0,255);
        ofSetColor(225, 255,255,progress);
        writeinPNL("TRY IT NOW");
    }
    
    if (bar >= 66.5 && bar < 66.75) {
        //fade out text
        float progress = ofMap(barfloat, 66.5, 66.75,255,0);
        ofSetColor(225, 255,255,progress);
        writeinPNL("TRY IT NOW");
    }
    
    if (bar >= 67.25 && bar < 68.5) {
        //fade in text
        float progress = ofMap(barfloat, 67, 67.25,0,255);
        ofSetColor(225, 255,255,progress);
        writeinPNL("TRY IT AGAIN");
    }
	...
	if (barfloat > 133 && barfloat < 140 ) {
	
			float progress = ofMap(barfloat, 133, 133.5, 0, 255);
